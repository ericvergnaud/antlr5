// $ANTLR 3.5.3 org/antlr/v5/codegen/SourceGenTriggers.g 2024-03-20 16:00:16
...
public class SourceGenTriggers extends TreeParser {
	...
	@Override public String getGrammarFileName() { return "org/antlr/v5/codegen/SourceGenTriggers.g"; }
	...
	// $ANTLR start "dummy"
	// org/antlr/v5/codegen/SourceGenTriggers.g:59:1: dummy : block[null, null] ;
	public final void dummy() throws RecognitionException {
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:59:7: ( block[null, null] )
			// org/antlr/v5/codegen/SourceGenTriggers.g:59:9: block[null, null]
			{
	...
	// $ANTLR start "block"
	// org/antlr/v5/codegen/SourceGenTriggers.g:61:1: block[GrammarAST label, GrammarAST ebnfRoot] returns [List<? extends SrcOp> omos] : ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ ) ;
	public final List<? extends SrcOp> block(GrammarAST label, GrammarAST ebnfRoot) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:62:5: ( ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ ) )
			// org/antlr/v5/codegen/SourceGenTriggers.g:62:7: ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ )
			{
			blk=(GrammarAST)match(input,BLOCK,FOLLOW_BLOCK_in_block84); 
			match(input, Token.DOWN, null); 
			// org/antlr/v5/codegen/SourceGenTriggers.g:62:20: ( ^( OPTIONS ( . )+ ) )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:62:21: ^( OPTIONS ( . )+ )
					{
					match(input,OPTIONS,FOLLOW_OPTIONS_in_block88); 
					match(input, Token.DOWN, null); 
					// org/antlr/v5/codegen/SourceGenTriggers.g:62:31: ( . )+
					int cnt1=0;
					loop1:
					while (true) {
						int alt1=2;
			...
			// org/antlr/v5/codegen/SourceGenTriggers.g:64:7: ( alternative )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:64:9: alternative
					{
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:79:1: alternative returns [CodeBlockForAlt altCodeBlock, List<SrcOp> ops] : a= alt[outerMost] ;
	public final SourceGenTriggers.alternative_return alternative() throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:86:5: (a= alt[outerMost] )
			// org/antlr/v5/codegen/SourceGenTriggers.g:86:7: a= alt[outerMost]
			{
	...
	// $ANTLR start "alt"
	// org/antlr/v5/codegen/SourceGenTriggers.g:89:1: alt[boolean outerMost] returns [CodeBlockForAlt altCodeBlock, List<SrcOp> ops] : ( ^( ALT ( elementOptions )? ( element )+ ) | ^( ALT ( elementOptions )? EPSILON ) );
	public final SourceGenTriggers.alt_return alt(boolean outerMost) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:95:2: ( ^( ALT ( elementOptions )? ( element )+ ) | ^( ALT ( elementOptions )? EPSILON ) )
			int alt7=2;
			alt7 = dfa7.predict(input);
			switch (alt7) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:95:4: ^( ALT ( elementOptions )? ( element )+ )
					{
					...
					match(input, Token.DOWN, null); 
					// org/antlr/v5/codegen/SourceGenTriggers.g:102:10: ( elementOptions )?
					int alt4=2;
					...
					// org/antlr/v5/codegen/SourceGenTriggers.g:102:26: ( element )+
					int cnt5=0;
					loop5:
					while (true) {
						int alt5=2;
						...
						switch (alt5) {
						case 1 :
							// org/antlr/v5/codegen/SourceGenTriggers.g:102:28: element
							{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:104:4: ^( ALT ( elementOptions )? EPSILON )
					{
					match(input,ALT,FOLLOW_ALT_in_alt212); 
					match(input, Token.DOWN, null); 
					// org/antlr/v5/codegen/SourceGenTriggers.g:104:10: ( elementOptions )?
					int alt6=2;
	...
	// $ANTLR start "element"
	// org/antlr/v5/codegen/SourceGenTriggers.g:108:1: element returns [List<? extends SrcOp> omos] : ( labeledElement | atom[null,false] | subrule | ACTION | SEMPRED | ^( ACTION elementOptions ) | ^( SEMPRED elementOptions ) );
	public final List<? extends SrcOp> element() throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:109:2: ( labeledElement | atom[null,false] | subrule | ACTION | SEMPRED | ^( ACTION elementOptions ) | ^( SEMPRED elementOptions ) )
			int alt8=7;
			switch ( input.LA(1) ) {
			case ASSIGN:
			case PLUS_ASSIGN:
			...
			switch (alt8) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:109:4: labeledElement
					{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:110:4: atom[null,false]
					{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:111:4: subrule
					{
					...
					break;
				case 4 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:112:6: ACTION
					{
					...
					break;
				case 5 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:113:6: SEMPRED
					{
					...
					break;
				case 6 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:114:4: ^( ACTION elementOptions )
					{
					...
					break;
				case 7 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:115:6: ^( SEMPRED elementOptions )
					{
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:118:1: labeledElement returns [List<? extends SrcOp> omos] : ( ^( ASSIGN ID atom[$ID,false] ) | ^( PLUS_ASSIGN ID atom[$ID,false] ) | ^( ASSIGN ID block[$ID,null] ) | ^( PLUS_ASSIGN ID block[$ID,null] ) );
	public final List<? extends SrcOp> labeledElement() throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:119:2: ( ^( ASSIGN ID atom[$ID,false] ) | ^( PLUS_ASSIGN ID atom[$ID,false] ) | ^( ASSIGN ID block[$ID,null] ) | ^( PLUS_ASSIGN ID block[$ID,null] ) )
			int alt9=4;
			...
			switch (alt9) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:119:4: ^( ASSIGN ID atom[$ID,false] )
					{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:120:4: ^( PLUS_ASSIGN ID atom[$ID,false] )
					{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:121:4: ^( ASSIGN ID block[$ID,null] )
					{
					...
					break;
				case 4 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:122:4: ^( PLUS_ASSIGN ID block[$ID,null] )
					{
	...
	// $ANTLR start "subrule"
	// org/antlr/v5/codegen/SourceGenTriggers.g:125:1: subrule returns [List<? extends SrcOp> omos] : ( ^( OPTIONAL b= block[null,$OPTIONAL] ) | ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) ) | block[null, null] );
	public final List<? extends SrcOp> subrule() throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:126:2: ( ^( OPTIONAL b= block[null,$OPTIONAL] ) | ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) ) | block[null, null] )
			int alt11=3;
			switch ( input.LA(1) ) {
			case OPTIONAL:
				{
			...
			switch (alt11) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:126:4: ^( OPTIONAL b= block[null,$OPTIONAL] )
					{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:130:4: ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) )
					{
					// org/antlr/v5/codegen/SourceGenTriggers.g:130:4: ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) )
					int alt10=2;
					...
					switch (alt10) {
						case 1 :
							// org/antlr/v5/codegen/SourceGenTriggers.g:130:6: ^(op= CLOSURE b= block[null,null] )
							{
							...
							break;
						case 2 :
							// org/antlr/v5/codegen/SourceGenTriggers.g:131:5: ^(op= POSITIVE_CLOSURE b= block[null,null] )
							{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:143:5: block[null, null]
					{
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:146:1: blockSet[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ^( SET ( atom[label,invert] )+ ) ;
	public final List<SrcOp> blockSet(GrammarAST label, boolean invert) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:147:5: ( ^( SET ( atom[label,invert] )+ ) )
			// org/antlr/v5/codegen/SourceGenTriggers.g:147:7: ^( SET ( atom[label,invert] )+ )
			{
			SET20=(GrammarAST)match(input,SET,FOLLOW_SET_in_blockSet506); 
			match(input, Token.DOWN, null); 
			// org/antlr/v5/codegen/SourceGenTriggers.g:147:13: ( atom[label,invert] )+
			int cnt12=0;
			loop12:
			while (true) {
				int alt12=2;
	...
	// $ANTLR start "atom"
	// org/antlr/v5/codegen/SourceGenTriggers.g:160:1: atom[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ( ^( NOT a= atom[$label, true] ) | range[label] | ^( DOT ID terminal[$label] ) | ^( DOT ID ruleref[$label] ) | ^( WILDCARD . ) | WILDCARD | terminal[label] | ruleref[label] | blockSet[$label, invert] );
	public final List<SrcOp> atom(GrammarAST label, boolean invert) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:161:2: ( ^( NOT a= atom[$label, true] ) | range[label] | ^( DOT ID terminal[$label] ) | ^( DOT ID ruleref[$label] ) | ^( WILDCARD . ) | WILDCARD | terminal[label] | ruleref[label] | blockSet[$label, invert] )
			int alt13=9;
			switch ( input.LA(1) ) {
			case NOT:
				{
			...
			switch (alt13) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:161:4: ^( NOT a= atom[$label, true] )
					{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:162:4: range[label]
					{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:163:4: ^( DOT ID terminal[$label] )
					{
					...
					break;
				case 4 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:164:4: ^( DOT ID ruleref[$label] )
					{
					...
					break;
				case 5 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:165:7: ^( WILDCARD . )
					{
					...
					break;
				case 6 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:166:7: WILDCARD
					{
					...
					break;
				case 7 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:167:9: terminal[label]
					{
					...
					break;
				case 8 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:168:9: ruleref[label]
					{
					...
					break;
				case 9 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:169:4: blockSet[$label, invert]
					{
	...
	// $ANTLR start "ruleref"
	// org/antlr/v5/codegen/SourceGenTriggers.g:172:1: ruleref[GrammarAST label] returns [List<SrcOp> omos] : ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? ) ;
	public final List<SrcOp> ruleref(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:173:5: ( ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? ) )
			// org/antlr/v5/codegen/SourceGenTriggers.g:173:7: ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? )
			{
			RULE_REF27=(GrammarAST)match(input,RULE_REF,FOLLOW_RULE_REF_in_ruleref685); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// org/antlr/v5/codegen/SourceGenTriggers.g:173:18: ( ARG_ACTION )?
				int alt14=2;
				...
				// org/antlr/v5/codegen/SourceGenTriggers.g:173:30: ( elementOptions )?
				int alt15=2;
	...
	// $ANTLR start "range"
	// org/antlr/v5/codegen/SourceGenTriggers.g:176:1: range[GrammarAST label] returns [List<SrcOp> omos] : ^( RANGE a= STRING_LITERAL b= STRING_LITERAL ) ;
	public final List<SrcOp> range(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:177:5: ( ^( RANGE a= STRING_LITERAL b= STRING_LITERAL ) )
			// org/antlr/v5/codegen/SourceGenTriggers.g:177:7: ^( RANGE a= STRING_LITERAL b= STRING_LITERAL )
			{
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:180:1: terminal[GrammarAST label] returns [List<SrcOp> omos] : ( ^( STRING_LITERAL . ) | STRING_LITERAL | ^( TOKEN_REF ARG_ACTION . ) | ^( TOKEN_REF . ) | TOKEN_REF );
	public final List<SrcOp> terminal(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:181:5: ( ^( STRING_LITERAL . ) | STRING_LITERAL | ^( TOKEN_REF ARG_ACTION . ) | ^( TOKEN_REF . ) | TOKEN_REF )
			int alt16=5;
			...
			switch (alt16) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:181:8: ^( STRING_LITERAL . )
					{
					...
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:182:7: STRING_LITERAL
					{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:183:7: ^( TOKEN_REF ARG_ACTION . )
					{
					...
					break;
				case 4 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:184:7: ^( TOKEN_REF . )
					{
					...
					break;
				case 5 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:185:7: TOKEN_REF
					{
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:188:1: elementOptions : ^( ELEMENT_OPTIONS ( elementOption )+ ) ;
	public final void elementOptions() throws RecognitionException {
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:189:5: ( ^( ELEMENT_OPTIONS ( elementOption )+ ) )
			// org/antlr/v5/codegen/SourceGenTriggers.g:189:7: ^( ELEMENT_OPTIONS ( elementOption )+ )
			{
			match(input,ELEMENT_OPTIONS,FOLLOW_ELEMENT_OPTIONS_in_elementOptions836); 
			match(input, Token.DOWN, null); 
			// org/antlr/v5/codegen/SourceGenTriggers.g:189:25: ( elementOption )+
			int cnt17=0;
			loop17:
			while (true) {
				int alt17=2;
	...
	// org/antlr/v5/codegen/SourceGenTriggers.g:192:1: elementOption : ( ID | ^( ASSIGN ID ID ) | ^( ASSIGN ID STRING_LITERAL ) | ^( ASSIGN ID ACTION ) | ^( ASSIGN ID INT ) );
	public final void elementOption() throws RecognitionException {
		try {
			// org/antlr/v5/codegen/SourceGenTriggers.g:193:5: ( ID | ^( ASSIGN ID ID ) | ^( ASSIGN ID STRING_LITERAL ) | ^( ASSIGN ID ACTION ) | ^( ASSIGN ID INT ) )
			int alt18=5;
			...
			switch (alt18) {
				case 1 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:193:7: ID
					{
					match(input,ID,FOLLOW_ID_in_elementOption857); 
					}
					break;
				case 2 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:194:9: ^( ASSIGN ID ID )
					{
					...
					break;
				case 3 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:195:9: ^( ASSIGN ID STRING_LITERAL )
					{
					...
					break;
				case 4 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:196:9: ^( ASSIGN ID ACTION )
					{
					...
					break;
				case 5 :
					// org/antlr/v5/codegen/SourceGenTriggers.g:197:9: ^( ASSIGN ID INT )
					{
