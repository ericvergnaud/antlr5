// $ANTLR 3.5.3 org/antlr/v5/parse/ActionSplitter.g 2024-03-20 16:00:16
...
public class ActionSplitter extends Lexer {
	...
	@Override public String getGrammarFileName() { return "org/antlr/v5/parse/ActionSplitter.g"; }
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:68:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// org/antlr/v5/parse/ActionSplitter.g:68:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); if (state.failed) return;

			// org/antlr/v5/parse/ActionSplitter.g:68:14: ( options {greedy=false; } : . )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// org/antlr/v5/parse/ActionSplitter.g:68:42: .
					{
	...
	public final void mLINE_COMMENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org/antlr/v5/parse/ActionSplitter.g:72:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
			// org/antlr/v5/parse/ActionSplitter.g:72:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
			{
			match("//"); if (state.failed) return;

			// org/antlr/v5/parse/ActionSplitter.g:72:12: (~ ( '\\n' | '\\r' ) )*
			loop2:
			while (true) {
				int alt2=2;
				...
				switch (alt2) {
				case 1 :
					// org/antlr/v5/parse/ActionSplitter.g:
					{
			...
			// org/antlr/v5/parse/ActionSplitter.g:72:26: ( '\\r' )?
			int alt3=2;
	...
	public final void mSET_NONLOCAL_ATTR() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:76:2: ( '$' x= ID '::' y= ID ( WS )? '=' expr= ATTR_VALUE_EXPR ';' )
			// org/antlr/v5/parse/ActionSplitter.g:76:4: '$' x= ID '::' y= ID ( WS )? '=' expr= ATTR_VALUE_EXPR ';'
			{
			match('$'); if (state.failed) return;
			...
			// org/antlr/v5/parse/ActionSplitter.g:76:23: ( WS )?
			int alt4=2;
	...
	public final void mNONLOCAL_ATTR() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:83:2: ( '$' x= ID '::' y= ID )
			// org/antlr/v5/parse/ActionSplitter.g:83:4: '$' x= ID '::' y= ID
			{
			match('$'); if (state.failed) return;
	...
	public final void mQUALIFIED_ATTR() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:87:2: ( '$' x= ID '.' y= ID {...}?)
			// org/antlr/v5/parse/ActionSplitter.g:87:4: '$' x= ID '.' y= ID {...}?
			{
			match('$'); if (state.failed) return;
	...
	public final void mSET_ATTR() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:91:2: ( '$' x= ID ( WS )? '=' expr= ATTR_VALUE_EXPR ';' )
			// org/antlr/v5/parse/ActionSplitter.g:91:4: '$' x= ID ( WS )? '=' expr= ATTR_VALUE_EXPR ';'
			{
			match('$'); if (state.failed) return;
			...
			// org/antlr/v5/parse/ActionSplitter.g:91:13: ( WS )?
			int alt5=2;
	...
	public final void mATTR() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:98:2: ( '$' x= ID )
			// org/antlr/v5/parse/ActionSplitter.g:98:4: '$' x= ID
			{
			match('$'); if (state.failed) return;
	...
	public final void mTEXT() throws RecognitionException {
		try {
			...
			// org/antlr/v5/parse/ActionSplitter.g:105:2: ( (c=~ ( '\\\\' | '$' ) | '\\\\$' | '\\\\' c=~ ( '$' ) |{...}? => '$' )+ )
			// org/antlr/v5/parse/ActionSplitter.g:105:4: (c=~ ( '\\\\' | '$' ) | '\\\\$' | '\\\\' c=~ ( '$' ) |{...}? => '$' )+
			{
			// org/antlr/v5/parse/ActionSplitter.g:105:4: (c=~ ( '\\\\' | '$' ) | '\\\\$' | '\\\\' c=~ ( '$' ) |{...}? => '$' )+
			int cnt6=0;
			loop6:
			while (true) {
				...
				switch (alt6) {
				case 1 :
					// org/antlr/v5/parse/ActionSplitter.g:105:6: c=~ ( '\\\\' | '$' )
					{
					c= input.LA(1);
					...
					break;
				case 2 :
					// org/antlr/v5/parse/ActionSplitter.g:106:5: '\\\\$'
					{
					match("\\$"); if (state.failed) return;
					...
					break;
				case 3 :
					// org/antlr/v5/parse/ActionSplitter.g:107:5: '\\\\' c=~ ( '$' )
					{
					match('\\'); if (state.failed) return;
					c= input.LA(1);
					...
					break;
				case 4 :
					// org/antlr/v5/parse/ActionSplitter.g:108:5: {...}? => '$'
					{
	...
	public final void mID() throws RecognitionException {
		try {
			// org/antlr/v5/parse/ActionSplitter.g:113:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// org/antlr/v5/parse/ActionSplitter.g:113:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// org/antlr/v5/parse/ActionSplitter.g:113:31: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop7:
			while (true) {
				int alt7=2;
	...
	public final void mATTR_VALUE_EXPR() throws RecognitionException {
		try {
			// org/antlr/v5/parse/ActionSplitter.g:119:2: (~ '=' (~ ';' )* )
			// org/antlr/v5/parse/ActionSplitter.g:119:4: ~ '=' (~ ';' )*
			{
			if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '<')||(input.LA(1) >= '>' && input.LA(1) <= '\uFFFF') ) {
				input.consume();
				state.failed=false;
			...
			// org/antlr/v5/parse/ActionSplitter.g:119:9: (~ ';' )*
			loop8:
			while (true) {
				int alt8=2;
	...
	public final void mWS() throws RecognitionException {
		try {
			// org/antlr/v5/parse/ActionSplitter.g:123:4: ( ( ' ' | '\\t' | '\\n' | '\\r' )+ )
			// org/antlr/v5/parse/ActionSplitter.g:123:6: ( ' ' | '\\t' | '\\n' | '\\r' )+
			{
			// org/antlr/v5/parse/ActionSplitter.g:123:6: ( ' ' | '\\t' | '\\n' | '\\r' )+
			int cnt9=0;
			loop9:
	...
	public void mTokens() throws RecognitionException {
		// org/antlr/v5/parse/ActionSplitter.g:1:39: ( COMMENT | LINE_COMMENT | SET_NONLOCAL_ATTR | NONLOCAL_ATTR | QUALIFIED_ATTR | SET_ATTR | ATTR | TEXT )
		int alt10=8;
		...
		switch (alt10) {
			case 1 :
				// org/antlr/v5/parse/ActionSplitter.g:1:41: COMMENT
				{
				...
				break;
			case 2 :
				// org/antlr/v5/parse/ActionSplitter.g:1:49: LINE_COMMENT
				{
				...
				break;
			case 3 :
				// org/antlr/v5/parse/ActionSplitter.g:1:62: SET_NONLOCAL_ATTR
				{
				...
				break;
			case 4 :
				// org/antlr/v5/parse/ActionSplitter.g:1:80: NONLOCAL_ATTR
				{
				...
				break;
			case 5 :
				// org/antlr/v5/parse/ActionSplitter.g:1:94: QUALIFIED_ATTR
				{
				...
				break;
			case 6 :
				// org/antlr/v5/parse/ActionSplitter.g:1:109: SET_ATTR
				{
				...
				break;
			case 7 :
				// org/antlr/v5/parse/ActionSplitter.g:1:118: ATTR
				{
				...
				break;
			case 8 :
				// org/antlr/v5/parse/ActionSplitter.g:1:123: TEXT
				{
